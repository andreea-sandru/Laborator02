...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            Log.d(Constants.TAG, "onCreate() method was invoked previously");

            if(savedInstanceState.containsKey(Constants.PASSWORD_TAG)) {
            ...
            if(savedInstanceState.containsKey(Constants.USERNAME_TAG)) {
                EditText usernameEditText = (EditText)findViewById(R.id.username_edit_text);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if(checkBox.isChecked()) {
            // save password and username in order to restore them later
            String psswd = passwordEditText.getText().toString();
            String username = usernameEditText.getText().toString();

            savedInstanceState.putString(Constants.PASSWORD_TAG, psswd);
            savedInstanceState.putString(Constants.USERNAME_TAG, username);
            savedInstanceState.putString(Constants.REMEMBER_ME_CHECKBOX, "true");
        }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if(savedInstanceState.containsKey(Constants.PASSWORD_TAG)) {
            String psswd = savedInstanceState.getString(Constants.PASSWORD_TAG);
            passwordEditText.setText(psswd);
        }
        ...
        if(savedInstanceState.containsKey(Constants.REMEMBER_ME_CHECKBOX)) {
            String state = savedInstanceState.getString(Constants.REMEMBER_ME_CHECKBOX);
            checkBox.setChecked(Boolean.getBoolean(state));
        }
    }
}
